...
class CategoryDataSource extends Component {
  ...
  constructor(props) {
    ...
    this.getCategoriesFromDynamoAsync = this.getCategoriesFromDynamoAsync.bind(
      this,
    );
  ...
  componentDidMount() {
    ...
    this.getCategoriesAsync().then(this.props.categoriesLoaded);
  }
  ...
  getCategoriesAsync() {
    return this.getCategoriesFromDynamoAsync().then(data => {
