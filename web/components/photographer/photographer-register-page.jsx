...
class PhotographerRegisterPage extends Component {
  ...
  registerPhotographer() {
    ...
    this.props.awsLogin
      .makeApiRequest(config.EventWriterApi, 'POST', '/event-writer/', {
        ...
        phone: phoneNumber,
        origin: `hello-retail/web-client-update-phone/${
  ...
  render() {
    if (this.state.registered) {
      return (
        <div>
          ...
          <p>
            You will get text messages to inform you of products that need their
            pictures taken.
          </p>
        </div>
      );
    ...
    return (
      <div>
        <h3>
          <em>Photographer Registration</em>
        </h3>
        <div>
          <label>
            Phone Number:
          ...
          <button
            disabled={!this.state.isPhoneNumberValid}
            onClick={this.registerPhotographer}
          >
            Register
          </button>
        </div>
