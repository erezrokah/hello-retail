...
class ProductDataSource extends Component {
  ...
  componentDidMount() {
    ...
    if (this.props.category) {
      return this.getProductsByCategoryAsync(this.props.category).then(
  ...
  getProductsByIdAsync(id) {
    return this.getProductByIdFromDynamoAsync(id).then(data => {
      const productList = [];
      productList.push({
  ...
  getProductsByCategoryAsync(category) {
    return this.getProductsByCategoryFromDynamoAsync(category).then(data => {
      const productList = [];
